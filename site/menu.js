// Общий скрипт для главного меню BikePark54 и динамической подгрузки тарифов.
//
...
// или BikePark54) и автоматически открывает меню на главной
// странице, если выбран BikePark54. В меню предусмотрены кнопки для
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Автооткрытие на главной. Ранее для BikePark54 меню открывалось автоматически,
    ...
    if (provider && provider !== 'BikePark54' && isIndex) {
